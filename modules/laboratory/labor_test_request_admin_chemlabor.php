...
/* Here begins the real work */
	...
	if(!$mode) /* Get the pending test requests */ 	{
		$sql="SELECT care_person.pid, care_person.selian_pid, name_first, name_last,batch_nr, tr.encounter_nr,tr.send_date,dept_nr,room_nr,tr.priority FROM care_test_request_".$subtarget." tr,
