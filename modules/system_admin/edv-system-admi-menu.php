...
<!--                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo 'WebERP Service Link'; ?></b> </FONT></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_rest_stock_weberp.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo 'Stock Link Configuration'; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_rest_income_weberp.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo 'Income Link Configuration'; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo 'Restrict Not Billed Items'; ?></b> </FONT></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_restrict_unbilled.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo 'Configure Viewing Not Billed Items'; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
           <!--  	<td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><a href="phpmyadmin-start.php?sid=<?php echo $sid . "&lang=" . $lang ?>"><?php echo $LDMySQLManage ?></a></b> </FONT></td>
